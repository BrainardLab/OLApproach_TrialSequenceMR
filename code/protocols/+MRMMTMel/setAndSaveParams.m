function [protocolParams,MaxMelDirection,MaxMelBackground, ol]  = setAndSaveParams(protocolParams)
...
backgroundAlternateDictionary = 'MRMMTMel.OLBackgroundParamsDictionary_MaxMel';
directionAlternateDictionary = 'MRMMTMel.OLDirectionParamsDictionary_MaxMel';
...
paramsSavePath = fullfile(getpref('MRMMTMel','parameterFilesBasePath'),protocolParams.observerID,protocolParams.todayDate);
...
directionObjectSavePath = fullfile(getpref('MRMMTMel','DirectionObjectsBasePath'),protocolParams.observerID,[protocolParams.todayDate, '_' protocolParams.sessionName]);
