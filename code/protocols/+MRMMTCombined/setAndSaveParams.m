...
backgroundAlternateDictionary = 'MRMMTCombined.OLBackgroundParamsDictionary_MaxMel';
directionAlternateDictionary = 'MRMMTCombined.OLDirectionParamsDictionary_MaxMel';
...
paramsSavePath = fullfile(getpref('MRMMTCombined','parameterFilesBasePath'),protocolParams.observerID,protocolParams.todayDate);
...
directionObjectSavePath = fullfile(getpref('MRMMTCombined','DirectionObjectsBasePath'),protocolParams.observerID,[protocolParams.todayDate, '_' protocolParams.sessionName]);
