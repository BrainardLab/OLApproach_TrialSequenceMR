function [protocolParams,LMSDirection,LMSBackground, ol]  = setAndSaveParams(protocolParams)
...
protocolParams.attentionEventProb = 0;
...
backgroundAlternateDictionary = 'MRMMTLMS.OLBackgroundParamsDictionary_MaxMel';
directionAlternateDictionary = 'MRMMTLMS.OLDirectionParamsDictionary_MaxMel';
...
paramsSavePath = fullfile(getpref('MRMMTLMS','parameterFilesBasePath'),protocolParams.observerID,protocolParams.todayDate);
...
receptorStrings = LMSDirection.describe.directionParams.photoreceptorClasses;
fieldSizes = [LMSDirection.describe.directionParams.fieldSizeDegrees, LMSDirection.describe.directionParams.fieldSizeDegrees, LMSDirection.describe.directionParams.fieldSizeDegrees, LMSDirection.describe.directionParams.fieldSizeDegrees];
protocolParams.receptors = GetHumanPhotoreceptorSS(LMSDirection.calibration.describe.S,receptorStrings,fieldSizes,protocolParams.observerAge,observerParams.pupilDiameterMm,[],[]);
...
directionObjectSavePath = fullfile(getpref('MRMMTLMS','DirectionObjectsBasePath'),protocolParams.observerID,[protocolParams.todayDate, '_' protocolParams.sessionName]);
